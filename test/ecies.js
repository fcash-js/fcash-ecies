...
describe('ECIES', function() {
  ...
  it('errors', function() {
    should.exist(fcore.errors.ECIES);
  });

  it('correctly fails if trying to decrypt a bad message', function() {
    var encrypted = fcore.util.buffer.copy(encBuf);
  ...
  it('decrypting uncompressed keys', function() {
    ...
    // test uncompressed
    var alicePrivateKey = new fcore.PrivateKey.fromObject({
      bn: '1fa76f9c799ca3a51e2c7c901d3ba8e24f6d870beccf8df56faf30120b38f360',
      compressed: false,
      network: 'livenet'
    });
    var alicePublicKey = new fcore.PublicKey.fromPrivateKey(alicePrivateKey); // alicePrivateKey.publicKey
